...
export function MeshGradientSVG() {
  ...
  useEffect(() => {
    const rect = document.querySelector(".mesh-svg-container svg")?.getBoundingClientRect()
    if (rect) {
  ...
  return (
    <motion.div
      className="relative w-full max-w-sm mx-auto p-8 rounded-lg mesh-svg-container"
      animate={{
        y: [0, -8, 0],
        scaleY: [1, 1.08, 1],
      }}
